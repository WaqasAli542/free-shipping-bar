<?php
namespace Waqas\FreeShippingBar\Model\ResourceModel;
...
/**
 * Class Entity
 * @package Waqas\FreeShippingBar\Model\ResourceModel
 */
class Entity extends AbstractDb
{
    ...
    {
        $this->_init('Waqas_free_shipping_bar', 'entity_id');
    }
    ...
    private function getAssociatedEntitiesMap()
    {
        if (!$this->_associatedEntitiesMap) {
            $this->_associatedEntitiesMap = \Magento\Framework\App\ObjectManager::getInstance()
                ->get(\Waqas\FreeShippingBar\Model\ResourceModel\Entity\AssociatedEntityMap::class)
                ->getData();
        }
